...
export default function Home() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4">
        <h2 className="text-sm font-semibold tracking-wide text-zinc-500 uppercase">Root notes</h2>
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4">
        <h2 className="text-sm font-semibold tracking-wide text-zinc-500 uppercase">Note detail</h2>
        ...
        {noteQuery.error ? <p className="mt-3 text-sm text-red-600">Failed to load note.</p> : null}
        {noteQuery.data ? (
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4">
        <h2 className="text-sm font-semibold tracking-wide text-zinc-500 uppercase">Rename note</h2>
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4">
        <h2 className="text-sm font-semibold tracking-wide text-zinc-500 uppercase">Delete note</h2>
        <div className="mt-3 grid gap-3">
          <input
            className="w-full rounded-md border border-zinc-200 px-3 py-2 text-sm"
            placeholder="Note id"
